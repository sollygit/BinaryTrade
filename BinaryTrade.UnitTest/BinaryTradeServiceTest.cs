...
{
    [TestFixture]
    public class BinaryTradeServiceTest
    {
        ...
        {
            // Arrange
            var mockService = new Mock<IBinaryTradeService>();
        ...
        private async Task SaveAsync_ThrowException(AssetTrade trade, string errorMessage)
        {
            var mockService = new Mock<IBinaryTradeService>();
